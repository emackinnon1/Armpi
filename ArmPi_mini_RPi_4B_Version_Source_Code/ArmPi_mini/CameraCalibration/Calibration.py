...
#calibrate the monocular camera 

def get_K_D(checkerboard_size, imgsPath, param_save_path):
    #Parameter 1: the number of the horizontal and vertical interior corner points of the chessboard
    #Parameter 2: the path of the image to be calibrated
    #Parameter 3: The saved path of the parameter file after calibration
    ...
    #Calibration of the acquired image storage path 
